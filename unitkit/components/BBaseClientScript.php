 ...
 * @version 1.0
 */
class BBaseClientScript extends CClientScript
{
    ...
    public function init()
    {
        ...
        $this->_i18nIds = BSiteI18n::model()->getI18nIds();
    ...
    {
        return "
		$.b.app.defaultMessage.modalConfirmation = '" . addslashes(B::t('unitkit', 'modal_confirmation')) . "';
		$.b.app.defaultMessage.modalRemoveAll = '" . addslashes(B::t('unitkit', 'modal_remove_selected')) . "';
		$.b.app.defaultMessage.modalBtnConfirm = '" . addslashes(B::t('unitkit', 'btn_confirm')) . "';
		$.b.app.defaultMessage.modalBtnCancel = '" . addslashes(B::t('unitkit', 'btn_cancel')) . "';
		$.b.app.defaultMessage.modalRemoveOne = '" . addslashes(B::t('unitkit', 'modal_remove_one')) . "';
		$.b.app.defaultMessage.selectInputAdd = '" . addslashes(B::t('unitkit', 'select_input_add')) . "';
        $.b.app.defaultMessage.selectInputUpdate = '" . addslashes(B::t('unitkit', 'select_input_update')) . "';
		";
    }
