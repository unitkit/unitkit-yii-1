 ...
 * @version 1.0
 */
class UBaseEditDataView extends CComponent
{
    ...
    {
        return ($this->_createTitle !== null) ? $this->_createTitle : Unitkit::t('unitkit', 'edit_create_title');
    }
    ...
    {
        return ($this->_updateTitle !== null) ? $this->_updateTitle : Unitkit::t('unitkit', 'edit_update_title');
    }
