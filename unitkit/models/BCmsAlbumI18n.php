...
/**
 * This is the model class for table "b_cms_album_i18n"
 *
 * @author Kévin Walter <walkev13@gmail.com>
 * @version 1.0
 */
class BCmsAlbumI18n extends CActiveRecord
{
    /**
    ...
    public function rules()
    {
        return array(
            //save
            array('b_cms_album_id, i18n_id, title', 'required', 'on' => array('insert', 'update')),
			array('title', 'required', 'on' => 'preInsert'),
            array('b_cms_album_id', 'unsafe', 'on' => array('insert', 'update')),
            ...
            // search
            array('b_cms_album_id, i18n_id, title',
                'safe', 'on' => 'search'),
        );
    }
