...
/**
 * This is the model class for table "b_cms_layout_i18n"
 *
 * @author Kévin Walter <walkev13@gmail.com>
 * @version 1.0
 */
class BCmsLayoutI18n extends CActiveRecord
{
    /**
    ...
    public function rules()
    {
        return array(
            //save
            array('b_cms_layout_id, i18n_id, name', 'required', 'on' => array('insert', 'update')),
			array('name', 'required', 'on' => 'preInsert'),
            array('b_cms_layout_id', 'unsafe', 'on' => array('insert', 'update')),
            ...
            // search
            array('b_cms_layout_id, i18n_id, name',
                'safe', 'on' => 'search'),
        );
    }
    ...
    public function relations()
    {
        return array(
            ...
            'bCmsLayout' => array(self::BELONGS_TO, 'BCmsLayout', 'b_cms_layout_id'),
        );
    }
