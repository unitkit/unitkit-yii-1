...
/**
 * This is the model class for table "u_cms_news_group_i18n"
 *
 * @author Kévin Walter <walkev13@gmail.com>
 * @version 1.0
 */
class UCmsNewsGroupI18n extends CActiveRecord
{
    /**
    ...
    public function rules()
    {
        return array(
            //save
            array('u_cms_news_group_id, i18n_id, name', 'required', 'on' => array('insert', 'update')),
			array('name', 'required', 'on' => 'preInsert'),
            array('u_cms_news_group_id', 'unsafe', 'on' => array('insert', 'update')),
            ...
            // search
            array('u_cms_news_group_id, i18n_id, name',
                'safe', 'on' => 'search'),
        );
    }
