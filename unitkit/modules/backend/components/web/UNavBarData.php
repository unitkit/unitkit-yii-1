 ...
 * @version 1.0
 */
class UNavBarData extends UBaseNavBarData
{
    /**
     * Instance of UPerson
     *
    ...
    {
        $i18ns = USiteI18n::model()->getI18nIds();
        $i18nsDDL = array();
        foreach ($i18ns as $id)
            $i18nsDDL[$id] = UI18n::labelI18n($id);

        $html = '<form method="post" class="current-language form-inline csrf" action="' . Yii::app()->request->url . '">
					 <span class="control-label">' . Unitkit::t('unitkit', 'navbar_current_language') . '</span>
				' . UHtml::dropDownList('language', Yii::app()->language, $i18nsDDL, array(
            'class' => 'input-medium language-selector',
            'id' => 'language-selector'
        ));

        foreach ($i18ns as $id)
            $html .= UHtml::hiddenField($id, Yii::app()->controller->createUrl('', array_merge($_GET, array(
                'language' => $id
            ))));
            ...
            'items' => array(
                array(
                    'items' => array(
                        array(
                            'label' => array(
                                'value' => Unitkit::t('backend', 'navbar_media'),
                                'url' => '#'
                            ),
                            'items' => array(
                                array(
                                    'label' => array(
                                        'value' => Unitkit::t('backend', 'navbar_message'),
                                    ...
                                    'items' => array(
                                        array(
                                            'label' => array(
                                                'value' => Unitkit::t('backend', 'navbar_message_group'),
                                ...
                                array(
                                    'label' => array(
                                        'value' => Unitkit::t('backend', 'navbar_mail'),
                                        'url' => '#',
                                        'htmlOptions' => array(
                                            'class' => 'disabled'
                                        )
                                    ...
                                    'items' => array(
                                        array(
                                            'label' => array(
                                                'value' => Unitkit::t('backend', 'navbar_mail_template'),
                                        ...
                                        array(
                                            'label' => array(
                                                'value' => Unitkit::t('backend', 'navbar_mail_template_group'),
                        ...
                        array(
                            'label' => array(
                                'value' => Unitkit::t('backend', 'navbar_cms'),
                                'url' => '#'
                            ),
                            'items' => array(
                                array(
                                    'label' => array(
                                        'value' => Unitkit::t('backend', 'navbar_cms_page'),
                                ...
                                array(
                                    'label' => array(
                                        'value' => Unitkit::t('backend', 'navbar_cms_menu'),
                                    ...
                                    'items' => array(
                                        array(
                                            'label' => array(
                                                'value' => Unitkit::t('backend', 'navbar_cms_menu_group'),
                                ...
                                array(
                                    'label' => array(
                                        'value' => Unitkit::t('backend', 'navbar_cms_layout'),
                                ...
                                array(
                                    'label' => array(
                                        'value' => Unitkit::t('backend', 'navbar_cms_widget'),
                                ...
                                array(
                                    'label' => array(
                                        'value' => Unitkit::t('backend', 'navbar_cms_image'),
                                ...
                                array(
                                    'label' => array(
                                        'value' => Unitkit::t('backend', 'navbar_cms_album'),
                                ...
                                array(
                                    'label' => array(
                                        'value' => Unitkit::t('backend', 'navbar_cms_news'),
                                    ...
                                    'items' => array(
                                        array(
                                            'label' => array(
                                                'value' => Unitkit::t('backend', 'navbar_cms_news_group'),
                                ...
                                array(
                                    'label' => array(
                                        'value' => Unitkit::t('backend', 'navbar_cms_social'),
                        ...
                        array(
                            'label' => array(
                                'value' => Unitkit::t('backend', 'navbar_parameter'),
                                'url' => '#'
                            ),
                            'items' => array(
                                array(
                                    'label' => array(
                                        'value' => Unitkit::t('backend', 'navbar_right'),
                                        'url' => '#',
                                        'htmlOptions' => array(
                                            'class' => 'disabled'
                                        )
                                    ...
                                    'items' => array(
                                        array(
                                            'label' => array(
                                                'value' => Unitkit::t('backend', 'navbar_person'),
                                        ...
                                        array(
                                            'label' => array(
                                                'value' => Unitkit::t('backend', 'navbar_person_group'),
                                        ...
                                        array(
                                            'label' => array(
                                                'value' => Unitkit::t('backend', 'navbar_role'),
                                        ...
                                        array(
                                            'label' => array(
                                                'value' => Unitkit::t('backend', 'navbar_group_role'),
                                ...
                                array(
                                    'label' => array(
                                        'value' => Unitkit::t('backend', 'navbar_auto_login'),
                                ...
                                array(
                                    'label' => array(
                                        'value' => Unitkit::t('backend', 'navbar_language'),
                                        'url' => '#',
                                        'htmlOptions' => array(
                                            'class' => 'disabled'
                                        )
                                    ...
                                    'items' => array(
                                        array(
                                            'label' => array(
                                                'value' => Unitkit::t('backend', 'navbar_site_i18n'),
                                        ...
                                        array(
                                            'label' => array(
                                                'value' => Unitkit::t('backend', 'navbar_i18n'),
                                ...
                                array(
                                    'label' => array(
                                        'value' => Unitkit::t('backend', 'navbar_variable'),
                                    ...
                                    'items' => array(
                                        array(
                                            'label' => array(
                                                'value' => Unitkit::t('backend', 'navbar_variable_group'),
                                ...
                                array(
                                    'label' => array(
                                        'value' => Unitkit::t('backend', 'navbar_cache'),
                                        'url' => '#',
                                        'htmlOptions' => array(
                                            'class' => 'disabled'
                                        )
                                    ...
                                    'items' => array(
                                        array(
                                            'label' => array(
                                                'value' => Unitkit::t('backend', 'navbar_db_schema_flush'),
                                        ...
                                        array(
                                            'label' => array(
                                                'value' => Unitkit::t('backend', 'url_manager_schema_flush'),
                    ...
                    'items' => array(
                        array(
                            ...
                            'items' => array(
                                array(
                                    'label' => array(
                                        'value' => Unitkit::t('backend', 'navbar_profile'),
                                ...
                                array(
                                    'label' => array(
                                        'value' => Unitkit::t('unitkit', 'navbar_logout'),
