...
Update by Kévin Walter <walkev13@gmail.com>
...
(function ($, undefined) {
                    ...
                    if (target.closest(".select2-update").length > 0) {
                        ...
                        $.b.app.ajax(
                            ...
                            function(data){
                                ...
                                // fill modal
                                modal.setBody($.parseHTML(data.html));
                                // open modal
                                modal.open();
                                ...
                                edit.initCloseActionEvent = function()
                                {
                                    ...
                                    this.main.find('.btn-close').on('click', function(){
                                        var value = $this.main.find(select.opts.item.relatedField).val();
                                        $this.destroySwfUpload();   
                                        $this.main.html('');
                                        modal.close();
                                        select.externalSearch(value || '');
                                        return false;
                                    });
                                };
                                edit.initEvents();
                            }, 
                            this.opts.updateItem.argument + '=' + select.val(), 
                            'GET', 
                            'JSON', 
                            true
                        );
            ...
            opts = $.extend({}, {
                populateResults: function(container, results, query) {
                    ...
                    populate=function(results, container, depth) {
                        ...
                        var i, l, result, selectable, disabled, compound, node, label, labelOption, innerContainer, formatted;
                        ...
                        for (i = 0, l = results.length; i < l; i = i + 1) {
                            ...
                            // unitkit
                            if(opts.updateItem) {
                                labelOption=$(document.createElement("div"));
    ...
    SingleSelect2 = clazz(AbstractSelect2, {
        ...
        initAddItem: function() {
        	...
        	this.addItem = this.container.find('.select2-add a');
        ...
        initContainer: function () {
	        ...
	        if(this.opts.addItem) {
	        	...
	        	this.container.find('.select2-add').hide();
