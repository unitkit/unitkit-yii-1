        ...
        <div class="col-lg-12">
            ...
            <?php if($models['ContactForm']->hasErrors()): ?>
                <div class="alert alert-danger">
                    <?= BHtml::errorSummary($models['ContactForm']); ?>
                </div>
            <?php endif; ?>

            <?php if($isSent): ?>
                <div class="alert alert-success">
                    <?= B::t('frontend', 'email_is_sent') ?>
                </div>
            <?php endif; ?>
            <form role="form" method="POST" class="csrf" action="<?= $this->createUrl($this->id.'/index'); ?>#contact_form">
                <div class="row">
                    <div class="form-group col-lg-4 <?= $models['ContactForm']->hasErrors('firstName') ? 'has-error' : ''; ?>">
                        ...
                        <?= BHtml::activeTextField($models['ContactForm'], 'firstName', array('class' => 'form-control')) ?>
                    </div>
                    <div class="form-group col-lg-4 <?= $models['ContactForm']->hasErrors('lastName') ? 'has-error' : ''; ?>">
                        ...
                        <?= BHtml::activeTextField($models['ContactForm'], 'lastName', array('class' => 'form-control')) ?>
                    </div>
                    <div class="form-group col-lg-4 <?= $models['ContactForm']->hasErrors('email') ? 'has-error' : ''; ?>">
                        ...
                        <?= BHtml::activeEmailField($models['ContactForm'], 'email', array('class' => 'form-control')) ?>
                    </div>
                    <div class="form-group col-lg-4 <?= $models['ContactForm']->hasErrors('phone') ? 'has-error' : ''; ?>">
                        ...
                        <?= BHtml::activeTelField($models['ContactForm'], 'phone', array('class' => 'form-control')) ?>
                    </div>
                    ...
                    <div class="form-group col-lg-12 <?= $models['ContactForm']->hasErrors('message') ? 'has-error' : ''; ?>">
                        ...
                        <?= BHtml::activeTextArea($models['ContactForm'], 'message', array('class' => 'form-control', 'rows' => 6)) ?>
                    </div>
                    <div class="form-group col-lg-12">
                        <input type="hidden" name="save" value="contact">
                        <button type="submit" class="btn btn-default"><?= B::t('unitkit', 'btn_send'); ?></button>
                    </div>
                </div>
            </form>
        </div>
